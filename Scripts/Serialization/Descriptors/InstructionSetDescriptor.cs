...
public sealed class InstructionSetDescriptor
{
    ...
    /// <summary>
    /// Generate a set descriptor from an instruction set.
    /// </summary>
    public InstructionSetDescriptor(InstructionSet set)
    {
        foreach (InstructionDefinition definition in set.Local)
        {
            Definitions.Add(Descriptor.FromObject(definition) as InstructionDefinitionDescriptor);
        }
    ...
    public InstructionSet Generate(bool makeIconsTransparent)
    {
        ...
        {
            definitions.Add(definition.GenerateObject(makeIconsTransparent));
        }
